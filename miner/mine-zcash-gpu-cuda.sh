...
kill $(pidof nheqminer_cuda_tromp)
kill $(pidof ewbf.bin)
...
~/minion/miner/ewbf.bin --user t1M5m81rqayq3D1LcGNX5rpFdVpdZXTRXtJ.`hostname`-gpu --server zec-eu1.dwarfpool.com --port 3336 --pass x --fee 0.001 &
